...
def build_speechlet_response(output, reprompt_text, should_end_session):
    return {
        ...
        'card': {
            'type': 'Simple',
            'title': "SessionSpeechlet - open door",
            'content': "SessionSpeechlet - open door"
        },
        'reprompt': {
            'outputSpeech': {
                'type': 'PlainText',
...
def open_door():
    ...
    session_attributes = {}
    speech_output = "Open Sesame."
    should_end_session = True
    return build_response(session_attributes, build_speechlet_response(
        speech_output, None, should_end_session))


def call_rest_service():
    path = 'https://api.particle.io/v1/devices/XXXXXXXXXXXXXXXXXXX/door'
    data = '{ "arg": "press" }'
